...
describe('AutomationEditor', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    (blocklyService.getToolboxConfig as jest.Mock).mockResolvedValue(mockToolboxConfig);
  });
  ...
  it('renders edit automation form with existing data', async () => {
    (automationService.getAutomation as jest.Mock).mockResolvedValue(mockAutomation);
  ...
  it('handles form submission for new automation', async () => {
    (automationService.createAutomation as jest.Mock).mockResolvedValue(mockAutomation);
    renderComponent();
  ...
  it('handles form submission for editing automation', async () => {
    (automationService.getAutomation as jest.Mock).mockResolvedValue(mockAutomation);
    (automationService.updateAutomation as jest.Mock).mockResolvedValue(mockAutomation);
  ...
  it('handles error state from toolbox loading', async () => {
    ...
    (blocklyService.getToolboxConfig as jest.Mock).mockRejectedValue(new Error(errorMessage));
  ...
  it('handles error state from automation loading', async () => {
    ...
    (automationService.getAutomation as jest.Mock).mockRejectedValue(new Error(errorMessage));
